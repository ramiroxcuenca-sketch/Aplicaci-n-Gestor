    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold" href="{{ route('inicio') }}">
                <i class="bi bi-journal-check"></i> Agenda Personal
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    @auth
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('tareas.*') ? 'active' : '' }}" href="{{ route('tareas.index') }}">Mis Tareas</a>
                        </li>
                        <li class="nav-item">
                    ...
                    @else
                        ...
                        <li class="nav-item ms-2">
                            <a class="btn btn-warning fw-bold text-dark" href="{{ route('register') }}">Registrarse</a>
                        </li>
                    @endauth
